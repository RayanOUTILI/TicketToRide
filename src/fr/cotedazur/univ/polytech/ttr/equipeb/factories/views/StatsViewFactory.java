...
public class StatsViewFactory {
    private final List<StatsWriter> statsWriter;
    private List<PlayerStatisticsView> statisticsViews;
    private final String label;

    public StatsViewFactory(List<StatsWriter> statsWriter, String label){
        this.statsWriter = statsWriter;
        this.statisticsViews = new ArrayList<>();
        this.label = label;
    }

    public List<PlayerStatisticsView> createStatsViewsForPlayers(List<PlayerType> playerTypes){
        this.statisticsViews = new ArrayList<>();
     ...
     */
    public IGameViewable createStatsViewForGameEngine(){
